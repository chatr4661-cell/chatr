...
function Ye(t, e, n) {
  ...
  const x = import_react.default.forwardRef((p, u) => {
  ...
  }, v = import_react.default.version.startsWith("18") ? I : C;
  return {
    Component: x,
    useEmitter: (p, u) => {
...
function to(t, e, n, o = Yt, r, s) {
  const i = import_react.default.useRef(null), l = import_react.default.useRef(null), c = import_react.default.useRef(null), a = import_react.default.useCallback(
    (h) => {
      ...
      h.suppressFlushSync ? p() : import_react_dom.default.flushSync(p), l.current !== null && (v === l.current || v <= 0 || v === I - C) && (l.current = null, e(true), c.current && (clearTimeout(c.current), c.current = null));
    },
    [t, e, s]
  );
...
var Cn = import_react.default.memo(function({ showTopList: e = false }) {
  ...
  return !e && n.totalCount === 0 && b ? (0, import_jsx_runtime.jsx)(b, { ...Z(b, m) }) : (0, import_jsx_runtime.jsx)(
    d,
    {
      ...Z(d, m),
...
function Je({ useEmitter: t, useEmitterValue: e, usePublisher: n }) {
  return import_react.default.memo(function({ children: s, style: i, context: l, ...c }) {
    ...
    return t("scrollTo", g), t("scrollBy", C), (0, import_jsx_runtime.jsx)(
      m,
      {
...
function Qe({ useEmitter: t, useEmitterValue: e, usePublisher: n }) {
  return import_react.default.memo(function({ children: s, style: i, context: l, ...c }) {
    const a = n("windowScrollContainerState"), m = e("ScrollerComponent"), x = n("smoothScrollTargetReached"), h = e("totalListHeight"), I = e("deviation"), C = e("customScrollParent"), v = import_react.default.useRef(null), g = e("scrollerRef"), { scrollByCallback: p, scrollerRef: u, scrollToCallback: T } = to(
      a,
      x,
      m,
      g,
    ...
    }, [u, C]), t("windowScrollTo", T), t("scrollBy", p), (0, import_jsx_runtime.jsx)(
      m,
      {
        ref: v,
        "data-virtuoso-scroller": true,
...
var Yr = oo;
var Sr = U(() => {
  const t = w((a) => (0, import_jsx_runtime.jsxs)("td", { children: [
    "Item $",
    a
  ] })), e = w(null), n = w((a) => (0, import_jsx_runtime.jsxs)("td", { colSpan: 1e3, children: [
    "Group ",
    a
...
var vn = import_react.default.memo(function({ showTopList: e = false }) {
  const n = W("listState"), o = W("computeItemKey"), r = W("firstItemIndex"), s = W("context"), i = W("isSeeking"), l = W("fixedHeaderHeight"), c = W("groupIndices").length > 0, a = W("itemContent"), m = W("groupContent"), x = W("ScrollSeekPlaceholder") || Tr, h = W("GroupComponent"), I = W("TableRowComponent"), C = (e ? n.topItems : []).reduce((g, p, u) => (u === 0 ? g.push(p.size) : g.push(g[u - 1] + p.size), g), []), v = (e ? n.topItems : n.items).map((g) => {
    const p = g.originalIndex, u = o(p + r, g.data, s), T = e ? p === 0 ? 0 : C[p - 1] : 0;
    return i ? (0, import_react.createElement)(
      ...
      c ? a(g.index, g.groupIndex, g.data, s) : a(g.index, g.data, s)
    );
  });
  return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: v });
});
var vr = import_react.default.memo(function() {
  const e = W("listState"), n = W("topItemsIndexes").length > 0, o = Ct("sizeRanges"), r = W("useWindowScroll"), s = W("customScrollParent"), i = Ct("windowScrollContainerState"), l = Ct("scrollContainerState"), c = s || r ? i : l, a = W("trackItemSizes"), m = W("itemSize"), x = W("log"), { callbackRef: h, ref: I } = On(
    o,
    m,
    a,
    c,
  ...
  ), [C, v] = import_react.default.useState(0);
  en("deviation", (z) => {
    C !== z && (I.current.style.marginTop = `${z}px`, v(z));
  });
  const g = W("EmptyPlaceholder"), p = W("FillerRow") || Cr, u = W("TableBodyComponent"), T = W("paddingTopAddition"), b = W("statefulTotalCount"), f = W("context");
  if (b === 0 && g)
    return (0, import_jsx_runtime.jsx)(g, { ...Z(g, f) });
  const d = (n ? e.topItems : []).reduce((z, _) => z + _.size, 0), y = e.offsetTop + T + C - d, B = e.offsetBottom, k = y > 0 ? (0, import_jsx_runtime.jsx)(p, { context: f, height: y }, "padding-top") : null, L = B > 0 ? (0, import_jsx_runtime.jsx)(p, { context: f, height: B }, "padding-bottom") : null;
  return (0, import_jsx_runtime.jsxs)(u, { "data-testid": "virtuoso-item-list", ref: h, ...Z(u, f), children: [
    k,
...
var br = import_react.default.memo(function(e) {
  const n = W("useWindowScroll"), o = W("customScrollParent"), r = Ct("fixedHeaderHeight"), s = Ct("fixedFooterHeight"), i = W("fixedHeaderContent"), l = W("fixedFooterContent"), c = W("context"), a = Ht(
    ...
    true,
    W("skipAnimationFrameInResizeObserver")
  ), x = o || n ? Er : Hr, h = o || n ? Rr : yr, I = W("TableComponent"), C = W("TableHeadComponent"), v = W("TableFooterComponent"), g = i ? (0, import_jsx_runtime.jsx)(
    C,
    {
      ref: a,
  ...
  return (0, import_jsx_runtime.jsx)(x, { ...e, ...Z(x, c), children: (0, import_jsx_runtime.jsx)(h, { children: (0, import_jsx_runtime.jsxs)(I, { style: { borderSpacing: 0, overflowAnchor: "none" }, ...Z(I, c), children: [
    g,
